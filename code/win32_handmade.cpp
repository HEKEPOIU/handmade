...
#define FrameOfAudioLatency 1.75
  ...
  if (RegisterClass(&WindowsClass)) {
    ...
    if (Window) {
      ...
      SoundOutput.LatencySampleCount =
          (int32_t)(FrameOfAudioLatency * (SoundOutput.SamplePerSecond / GameUpdateHz));
